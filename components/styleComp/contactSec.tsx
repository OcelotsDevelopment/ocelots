            ...
            <div>
              <div className="text-xl mb-1 flex flex-col items-center ">
                ...
                >
                  <path
                    fill="#fff"
                    d="M11.924.633a11.41 11.41 0 0 1 11.411 11.412c0 4.821-3.388 10.077-10.077 15.82a2.05 2.05 0 0 1-2.672-.002l-.442-.383C3.75 21.885.513 16.759.513 12.044A11.41 11.41 0 0 1 11.923.634m0 1.756a9.656 9.656 0 0 0-9.656 9.656c0 4.098 2.982 8.82 9.029 14.11l.436.379a.29.29 0 0 0 .382 0c6.338-5.445 9.465-10.294 9.465-14.49a9.656 9.656 0 0 0-9.656-9.655m0 5.267a4.39 4.39 0 1 1 0 8.778 4.39 4.39 0 0 1 0-8.778m0 1.755a2.633 2.633 0 1 0 0 5.266 2.633 2.633 0 0 0 0-5.266"
                  ></path>
                </svg>
              </div>
              <p>Location</p>
              <p className="text-sm mt-1">Kochi Kerala</p>
            </div>
          </div>
          {/* Map */}
